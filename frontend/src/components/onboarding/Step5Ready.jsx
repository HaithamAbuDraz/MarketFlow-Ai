...
export const Step5Ready = ({ data, onFinish }) => {
  ...
  return (
    <div className="w-full max-w-[560px] bg-white rounded-[20px] p-6 sm:p-10 drop-shadow-[0px_8px_16px_rgba(15,23,42,0.06)] border border-[#e2e8f0]/80 flex flex-col items-center gap-8 animate-modal-in">
      {/* Success Visual */}
      <div className="relative flex items-center justify-center">
        <div className="w-[130px] h-[130px] sm:w-[140px] sm:h-[140px] rounded-full bg-[rgba(37,99,235,0.08)] flex items-center justify-center animate-pulse-glow">
      ...
      <div className="flex flex-col items-center text-center gap-2">
        ...
        <p className="text-sm sm:text-[16px] text-[#475569] leading-relaxed max-w-sm">
          Your MarketFlow store is set up and ready to manage.
        </p>
      </div>

      {/* Store Summary Card */}
      <div className="w-full bg-white border border-[#e5e7eb] rounded-[10px] p-5 flex flex-col gap-4">
        {/* Row 1: Store Name */}
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-xs text-[#2563eb] hover:text-blue-700 font-medium cursor-pointer"
            >
              {copied ? (
                <>
          ...
          <span className="text-[15px] font-semibold text-[#2563eb] break-all">
            {fullStoreUrl}
          </span>
        </div>
      </div>
