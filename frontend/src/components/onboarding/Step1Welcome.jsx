  ...
  return (
    <div className="w-full max-w-[560px] bg-white rounded-[20px] p-6 sm:p-10 drop-shadow-[0px_8px_16px_rgba(15,23,42,0.06)] border border-[#e2e8f0]/80 flex flex-col items-center gap-8 animate-modal-in">
      ...
      <div className="w-full flex flex-col items-center text-center gap-3">
        <h1 className="text-2xl sm:text-[32px] font-bold sm:font-semibold text-[#0f172a] leading-tight tracking-tight">
          Welcome to MarketFlow AI
        </h1>
        <p className="text-base sm:text-[18px] font-medium text-[#2563eb] leading-normal">
          Let&apos;s get your store ready.
        </p>
        <p className="text-sm sm:text-[14px] font-normal text-[#475569] leading-relaxed max-w-md">
      ...
      {/* Bottom Trust Note */}
      <div className="flex items-center justify-center gap-2 text-[#98a2b3] text-sm sm:text-[15px] pt-1">
